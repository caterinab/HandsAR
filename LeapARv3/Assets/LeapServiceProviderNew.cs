...
namespace Leap.Unity
{
...
#if UNITY_ANDROID
        protected int ExtrapolationAmount = 15; //15
        protected int BounceAmount = 70; //70
#else
    ...
    protected int BounceAmount = 0;
        ...
        protected Frame _untrasformedTestFixedFrame;
        ...
        //Custom
      //  private FrameProviderNew fpnew;
        ...
        protected virtual void Start()
        {
            ...
            _untrasformedTestFixedFrame = new Frame();
        ...
        protected virtual void Update()
        {
         ...
         //   leap_controller_.Frame(_untrasformedTestFixedFrame);
            ...
            /*   if (_untrasformedTestFixedFrame.Hands.Count > 0)
              ...
              // Debug.Log("LATESTFRAME frame PALMWIDTH: " + FrameProviderNew.latestFrame.Hands[0].PalmWidth);

               if (_untransformedUpdateFrame.Hands.Count > 0)
               Debug.Log("Frameprovider frame PALMWIDTH: " + _untransformedUpdateFrame.Hands[0].PalmWidth);

               /*if (_untransformedUpdateFrame.Hands.Count > 0 && _untransformedUpdateFrame.Hands[0].PalmWidth == 0)
                   Debug.Log("PALM WIDTH 0");
                   */


            //_transformedUpdateFrame = frameProvider.latestFrame;
            imageTimeStamp = _untransformedUpdateFrame.Timestamp;
        ...
        protected virtual void FixedUpdate()
        {
            ...
            //Debug.Log(_untransformedFixedFrame.Id);
             ...
             {
                 DispatchFixedFrameEvent(_untransformedFixedFrame);
             }
