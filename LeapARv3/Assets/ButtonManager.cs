...
public class ButtonManager : MonoBehaviour {
    ...
    */
    ...
    public void CaptureScreenshot()
    {
        ...
        //Debug.Log(GameObject.Find("LeapMotionController").GetComponent<WebsocketConnection>().jsonFrameString);   // gets cut at 1KB
    ...
    {
        GameObject.Find("LeapMotionController").transform.localPosition = new Vector3(0, 0, 0);
    }

    public void SaveOffset() {
        Vector3 p = GameObject.Find("LeapMotionController").transform.localPosition;
    ...
    public void IncrementX() {
        ...
        GameObject.Find("LeapMotionController").transform.localPosition = p;
    }
