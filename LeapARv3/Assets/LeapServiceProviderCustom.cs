...
namespace Leap.Unity
{
    ...
    /// </summary>
    public class LeapServiceProviderCustom : LeapProvider
    {
    ...
    protected int BounceAmount = 70;
        ...
        protected virtual void Update()
        {
            ...
            */
            ...
            Debug.Log(_untransformedUpdateFrame);

            if (_untransformedUpdateFrame != null)
            {
                //Debug.Log(_transformedUpdateFrame);
        ...
        public void CopySettingsToLeapXRServiceProvider(
            LeapXRServiceProviderCustom leapXRServiceProvider)
        {
