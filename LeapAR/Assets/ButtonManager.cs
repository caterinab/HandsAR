...
public class ButtonManager : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        GameObject.Find("LeapHandController").transform.position = new Vector3(x, y, z);
    ...
    public void ResetOffset()
    {
        ...
        GameObject.Find("LeapHandController").transform.position = new Vector3(0, 0, 0);
    }

    public void IncrementX() {
        Vector3 p = GameObject.Find("LeapHandController").transform.position;

        p.x += delta;

        GameObject.Find("LeapHandController").transform.position = new Vector3(p.x, p.y, p.z);
